...
import com.entreprise.projet.domain.CarRepository;
import com.entreprise.projet.domain.Owner;
import com.entreprise.projet.domain.OwnerRepository;
...
public class SpringApp {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			urepository.save(new Utilisateur("user", "$2a$04$1.YhMIgNX/8TkCKGFUONWO1waedKhQ5KrnB30fl0Q01QKqmzLf.Zi", "CLIENT"));
